	...
	<head>
  	...
  	<body>
    	<div class="container col-md-5 offset-md-3.6">
    		...
    		<h5><center>Update Data Jenjang Studi</center></h5>
    		<div class="box-regis">
    			<form action="" method="post">
				<div class="form-group">
					<label>Jenjang Studi</label>
					<input type="text" id="nama_jenjang_studi" class="form-control" name="nama_jenjang_studi" value="<?php echo $jenjang['nama_jenjang_studi']; ?>" placeholder="Jenjang Studi">
          <small class="form-text text-danger"><b><?= form_error('nama_jenjang_studi');?></b></small>
				</div>
        <input type="hidden" name="id" value="<?php echo $jenjang['id']; ?>">
				<center>
