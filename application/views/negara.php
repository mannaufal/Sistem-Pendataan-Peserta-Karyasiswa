              ...
              <div class="table-responsive">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo site_url('Negara/ubah_negara/'.$negara_1['kode_negara']);?>" class="btn-sm btn-info">Edit</a>
                      </td>
                      <td>
                       <a href="<?php echo site_url('Negara/hapus_negara/'.$negara_1['kode_negara']);?>" class ="btn-sm btn-danger tombol-hapus">Delete</a>
                      </td>
                    </tr>
                  </tbody>
                <?php endforeach; ?>
