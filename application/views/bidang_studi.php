              ...
              <div class="table-responsive">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                          <a href="<?php echo site_url('Bidang_studi/ubah_bidang_studi/'.$bidang['id']);?>" class="btn-sm btn-info">Edit</a>
                        </td>
                        <td>
                         <a href="<?php echo site_url('Bidang_studi/hapus_bidang_studi/'.$bidang['id']);?>" class ="btn-sm btn-danger tombol-hapus">Delete</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
