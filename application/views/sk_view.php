  ...
  <body>
        ...
        <!-- Page Content  -->
              ...
              <div class="table-responsive">
                  ...
                  <?php $i = 1;
                  foreach ($s_keterangan as $s_keterangan) : ?>
                  <tbody>
                    <tr>
                      <td scope="row"><?php echo ++$start; ?></td>
                      <td><?php echo $s_keterangan['nip']; ?></td>
                      <td><?= $s_keterangan['nama']; ?></td>
                      <td><?php echo $s_keterangan['sk_setjen']; ?></td>
                      <td><?php echo $s_keterangan['sk_menteri']; ?></td>
                      <td>
                        <a href="<?php echo site_url('Surat_keterangan/ubah_sk/'.$s_keterangan['nip']);?>" class="btn-sm btn-info">Edit</a>
                      </td>
                      <td>
                       <a href="<?php echo site_url('Surat_keterangan/hapus_sk/'.$s_keterangan['nip']);?>" class ="btn-sm btn-danger tombol-hapus">Delete</a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
