              ...
              <div class="table-responsive">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                          <a href="<?php echo site_url('Jenjang_studi/ubah_jenjang_studi/'.$jenjang['id']);?>" class="btn-sm btn-info">Edit</a>
                        </td>
                        <td>
                         <a href="<?php echo site_url('Jenjang_studi/hapus_jenjang_studi/'.$jenjang['id']);?>" class ="btn-sm btn-danger tombol-hapus">Delete</a>
                        </td>
                      <tr>
                    <?php endforeach; ?>
