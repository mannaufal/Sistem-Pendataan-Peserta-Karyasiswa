    		...
    		<div class="box-regis">
    			<form action="" method="post">
    				<div class="form-group">
    					<label>NIP</label>
    					<input type="text" class="form-control" name="nip" placeholder="NIP" value="<?php echo $peserta['nip']?>" readonly>
              <small class="form-text text-danger"><b><?= form_error('nip');?></b></small>
    				</div>
            <div class="form-group">
              <label>Nama</label>
              <input type="text" class="form-control" name="nama" placeholder="Nama" value="<?php echo $peserta['nama']?>" readonly>
              <small class="form-text text-danger"><b><?= form_error('nama');?></b></small>
            </div>
    				<div class="form-group">
    					<label>SK Setjen</label>
    					<input type="text" class="form-control" name="sk_setjen" placeholder="SK Setjen" value="<?php echo set_value('sk_setjen')?>">
              <small class="form-text text-danger"><b><?= form_error('sk_setjen');?></b></small>
    				</div>
				    <div class="form-group">
      				<label>SK Menteri</label>
      				<input class="form-control" name="sk_menteri" placeholder="SK Menteri" value="<?php echo set_value('sk_menteri')?>">
