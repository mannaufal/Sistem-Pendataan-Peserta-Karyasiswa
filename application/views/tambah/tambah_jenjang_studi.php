	...
	<head>
  	...
  	<body>
    	<div class="container col-md-5 offset-md-3.6">
    		...
    		<h5><center>Tambah Data Jenjang Studi</center></h5>
    		<div class="box-regis">
    			<form action="<?php echo site_url('jenjang_studi/tambah_jenjang_studi'); ?>" method="post">
				<div class="form-group">
					<label>Jenjang Studi</label>
					<input type="text" class="form-control" name="jenjang_studi" placeholder="Jenjang Studi">
          <small class="form-text text-danger"><b><?= form_error('jenjang_studi');?></b></small>
				</div>
				<center>
					<button type="submit" class="btn btn-primary">Tambah</button>
					<a href="../Jenjang_Studi" class="btn btn-info">Cancel</a>
				</center>
			</form>
    		</div>
    	</div>
