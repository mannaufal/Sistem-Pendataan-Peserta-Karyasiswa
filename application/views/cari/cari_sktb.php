  ...
  <body>
        ...
        <!-- Page Content  -->
              ...
              <nav class="navbar navbar-light bg-transparent float-right">
                <form action="<?= site_url('Sktb/cari_sktb_view') ?>" method="post">
              ...
              <div class="table-responsive">
                  ...
                  <thead>
                    <tr class="table-info">
                      ...
                      <th scope="col">No.SKTB</th>
                      <th scope="col">Mulai Pendidikan</th>
                  ...
                  <tbody>
                    <?php $i = 1; foreach ($sktb_1 as $sktb_1) : ?>
                    <tr>
                      <td><?php echo ++$start; ?></td>
                      <td><?php echo $sktb_1['nip']; ?></td>
                      <td><?php echo $sktb_1['nama']; ?></td>
                      <td><?php echo $sktb_1['no_sktb']; ?></td>
                      <td><?php echo $sktb_1['mulai_pendidikan']; ?></td>
                      <td><?php echo $sktb_1['rencana_selesai']; ?></td>
                      <td>
                        <a href="<?= site_url('Sktb/detail_sktb/'.$sktb_1['nip']);?>" class="btn-sm btn-secondary">Detail</a>
                      </td>
                      <td>
                        <a href="<?php echo site_url('Sktb/hapus_sktb/'.$sktb_1['nip']);?>" class ="btn-sm btn-danger tombol-hapus" onclick="return confirm('Data Ingin Dihapus?');">Delete</a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                  <?php if (empty ($sktb_1)) : ?>
              ...
              <center>
                <a href="<?= site_url('/Sktb') ?>" class="btn btn-primary btn-sm">Back</a>
              </center>
        		</div>
