  ...
  <body>
        ...
        <!-- Page Content  -->
              ...
              <nav class="navbar navbar-light bg-transparent">
                <a href="<?php echo site_url ('Bidang_studi/tambah_bidang_studi_view') ?>"><button type="button" class="btn btn-primary">Tambah Data</button></a>
                <form action="<?= site_url('Bidang_studi/cari_bidang_view') ?>" method="post">
              ...
              <div class="table-responsive">
                  ...
                  <tbody>
                   <?php $i = 1; foreach ($bidang as $bidang) : ?>
                    <tr>
                      <td><?php echo ++$start; ?></td>
                      <td><?php echo $bidang['nama_bidang_studi']; ?></td>
                      <td>
                          <a href="<?php echo site_url('Bidang_studi/ubah_bidang_studi_view/'.$bidang['id']);?>" class="btn-sm btn-info">Edit</a>
                        </td>
                        <td>
                         <a href="<?php echo site_url('Bidang_studi/hapus_bidang_studi/'.$bidang['id']);?>" class ="btn-sm btn-danger" onclick="return confirm('Data Ingin Dihapus?');">Delete</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                    <?php if (empty ($bidang)) : ?>
              ...
              <center>
                <a href="<?= site_url('/Bidang_studi') ?>" class="btn btn-primary btn-sm">Back</a>
              </center>
        		</div>
        		<!-- End Of Container !-->
        	</div>
