    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <!-- Page Content  -->
              ...
              <nav class="navbar navbar-light bg-transparent">
                <a href="<?php echo site_url ('Jenjang_studi/tambah_jenjang_studi_view') ?>"><button type="button" class="btn btn-primary">Tambah Data</button></a>
                <form action="<?= site_url('Jenjang_studi/cari_jenjang_view') ?>" method="post">
              ...
              <div class="table-responsive">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $jenjang['nama_jenjang_studi']; ?></td>
                      <td>
                          <a href="<?php echo site_url('Jenjang_studi/ubah_jenjang_studi_view/'.$jenjang['id']);?>" class="btn-sm btn-info">Edit</a>
                        </td>
                        <td>
                         <a href="<?php echo site_url('Jenjang_studi/hapus_jenjang_studi/'.$jenjang['id']);?>" class ="btn-sm btn-danger" onclick="return confirm('Data Ingin Dihapus?');">Delete</a>
                        </td>
                      <tr>
                    <?php endforeach; ?>
              ...
              <center>
                <a href="<?= site_url('/Jenjang_studi') ?>" class="btn btn-primary btn-sm">Back</a>
              </center>
        		</div>
        		<!-- End Of Container !-->
        	</div>
