  ...
  <body>		<div class="wrapper d-flex align-items-stretch">
        ...
        <!-- Page Content  -->
              ...
              <nav class="navbar navbar-light bg-transparent">
                <a href="<?php echo site_url('Negara/tambah_negara_view') ?>"><button type="button" class="btn btn-primary">Tambah Data</button></a>
                <form action="<?= site_url('Negara/cari_negara_view') ?>" method="post">
              ...
              <div class="table-responsive">
                  ...
                  <tbody>
                    <?php $i = 1; foreach ($negara_1 as $negara_1) : ?>
                    <tr>
                      <td><?php echo ++$start; ?></td>
                      <td><?php echo $negara_1['kode_negara']; ?></td>
                      <td><?php echo $negara_1['negara'] ?></td>
                      <td>
                        <a href="<?php echo site_url('Negara/ubah_negara_view/'.$negara_1['kode_negara']);?>" class="btn-sm btn-info">Edit</a>
                      </td>
                      <td>
                       <a href="<?php echo site_url('Negara/hapus_negara/'.$negara_1['kode_negara']);?>" class ="btn-sm btn-danger" onclick="return confirm('Data Ingin Dihapus?');">Delete</a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                  </tbody>
                <?php if (empty ($negara_1)) : ?>
              ...
              <center>
                <a href="<?= site_url('/Negara') ?>" class="btn btn-primary btn-sm">Back</a>
              </center>
        		</div>
        		<!-- End Of Container !-->
        	</div>
