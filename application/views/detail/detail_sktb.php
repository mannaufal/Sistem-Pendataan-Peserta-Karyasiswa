        		...
        		<div class="container md-4">
        			<div class="card">
  						<div class="card-header bg-secondary">
    						<center><h4 class="text-light">Detail Data Surat Keterangan Tugas Belajar</h4></center>
  						</div>
  						<div class="card-body">
    						<table class="table table-striped">
  								<tbody>
								    ...
								    <tr>
								      	<td>Nomor SKTB : </td>
								      	<td><?= $sktb_1['no_sktb']; ?></td>
								    </tr>
								    <tr class="table-info">
								    	<td>Mulai Pendidikan : </td>
								    	<td><?= $sktb_1['mulai_pendidikan']; ?></td>
								    </tr>
								    <tr>
								      	<td>Rencana Selesai : </td>
								      	<td><?= $sktb_1['rencana_selesai']; ?></td>
								    </tr>
								    <tr class="table-info">
								    	<td>No.SKTB Perpanjangan 1 : </td>
								    	<td><?= $sktb_1['no_sktb_perpanjangan_1']; ?></td>
								    </tr>
								    <tr>
								      	<td>Mulai Perpanjangan 1 : </td>
								      	<td><?= $sktb_1['mulai_perpanjangan_1']; ?></td>
								    </tr>
								    <tr class="table-info">
								    	<td>Selesai Perpanjangan 1 : </td>
								    	<td><?= $sktb_1['selesai_perpanjangan_1']; ?></td>
								    </tr>
								    <tr>
								      	<td>No.SKTB Perpanjangan 2 : </td>
								      	<td><?= $sktb_1['no_sktb_perpanjangan_2']; ?></td>
								    </tr>
								    <tr class="table-info">
								    	<td>Mulai Perpanjangan 2 : </td>
								    	<td><?= $sktb_1['mulai_perpanjangan_2']; ?></td>
								    </tr>
								    <tr>
								      	<td>Selesai Perpanjangan 2 : </td>
								      	<td><?= $sktb_1['selesai_perpanjangan_2']; ?></td>
								    </tr>
								</tbody> 
							</table><br>
              <a href="<?= site_url('Sktb/ubah_sktb/'.$sktb_1['nip']);?>" class="btn btn-info">Edit</a>
